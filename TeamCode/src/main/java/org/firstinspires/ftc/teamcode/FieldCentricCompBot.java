...
public class FieldCentricCompBot extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            double rightBackPower = (rotY + rotX - yaw) * 0.4;
            double leftBackPower = (rotY - rotX + yaw) * 0.4;
            double rightFrontPower = (rotY - rotX - yaw) * 0.4;
            double leftFrontPower = (rotY + rotX + yaw) * 0.4;
