...
@TeleOp(name = "Red Team Prop Tracker")

public class CameraPIDFusedRedProp extends LinearOpMode {
    ...
    // TODO: Change the following two variables with measurements from the team props
    ...
    public static final double focalLength = 873;  // Replace with the focal length of the camera in pixels
    ...
    private void initOpenCV() {
        ...
        controlHubCam.setPipeline(new RedPropDetectionPipeline());

        controlHubCam.openCameraDevice();
        controlHubCam.startStreaming(CAMERA_WIDTH, CAMERA_HEIGHT, OpenCvCameraRotation.UPRIGHT);
    }
    class RedPropDetectionPipeline extends OpenCvPipeline {
        @Override
